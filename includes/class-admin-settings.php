...
class Admin_Settings {
    ...
    public function settings_page() {
        ...
        <div class="wrap mp-wrap">
            ...
            <div class="mp-banner">
                <div>
                    <div class="mp-banner-title">&#x2728; MarketPulse</div>
                    <div class="mp-banner-sub">WordPress Site Management</div>
                </div>
                <a href="http://localhost:8080" target="_blank">Open Dashboard &rarr;</a>
            </div>
            ...
            <div class="mp-card">
                ...
                <p style="font-size: 13px; color: var(--mp-text-muted); margin: 0 0 16px 0;">
                    Enter your license key to connect this WordPress site to your MarketPulse dashboard.
                </p>
            ...
            <!-- Features & GA4 managed from MarketPulse dashboard -->
            <?php endif; ?>
