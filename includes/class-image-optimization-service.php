...
class Image_Optimization_Service {
    ...
    private function register_hooks() {
        ...
        add_action( 'wp_ajax_BIZGROWHUB_bulk_optimize', array( $this, 'bulk_optimize' ) );
    }
    ...
    private function get_stats() {
        return get_option( 'BIZGROWHUB_image_stats', array(
            'total_optimized' => 0,
            'bytes_saved'     => 0,
            'webp_converted'  => 0,
            'avif_converted'  => 0,
    ...
    private function update_stats( $new_stats ) {
        ...
        update_option( 'BIZGROWHUB_image_stats', $this->stats );
    }
    ...
    public function send_stats() {
        $this->api_client->make_request( BIZGROWHUB_ENDPOINT_IMAGE_STATS, $this->stats );
    }
