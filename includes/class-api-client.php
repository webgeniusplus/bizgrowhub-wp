...
class API_Client {
    ...
    public function __construct() {
        $this->api_base_url = MARKETPULSE_API_BASE_URL;
    }
    ...
    private function get_license_key() {
        return get_option( MARKETPULSE_OPTION_LICENSE_KEY, '' );
    }
    ...
    public function is_active() {
        return ! empty( $this->get_license_key() )
            && get_option( MARKETPULSE_OPTION_LICENSE_STATUS, 'inactive' ) === 'active';
    }
