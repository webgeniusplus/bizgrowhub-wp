...
define( 'INSIGHT_HUB_VERSION', '1.0.0' );
...
define( 'INSIGHT_HUB_API_BASE_URL', 'https://bizgrowhub.shop/api' );
...
class InsightHub_Plugin {
    ...
    public static function init() {
        // Load textdomain
        load_plugin_textdomain( 'insight-hub', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' );
        ...
        error_log('INSIGHT_HUB: About to init WooCommerce_Guard...');
        new \InsightHub\WooCommerce_Guard();
        error_log('INSIGHT_HUB: WooCommerce_Guard initialized');
